...
const api_url_get_signal= server_url + 'v4/signal/';
const api_url_get_all_signals= server_url + 'v4/signals/100'; // "0" for all signals. Better to define a limit such as 100.
const api_url_post_put_signal= server_url + 'v4/webhook';
// define other api constants (defining as a separate constant to be used as a standalone script):
const api_url_get_all_ticker= server_url + 'v4/tickers/0';
const api_url_get_all_pair= server_url + 'v4/pairs/0';
